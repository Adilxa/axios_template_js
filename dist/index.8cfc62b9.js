...
(0, _axiosDefault.default).get("https://jsonplaceholder.typicode.com/users").then((response)=>{
    console.log(response.data);
}).catch((error)=>{
    console.error("Error fetching data:", error);
});
...
},{"adfd9b103875c2dd":"f2bYa","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f2bYa":[function(require,module,exports,__globalThis) {
/*!
...
},{"5d2ce52638114663":"cOgIN","8970417cb9c0302c":"llcxu"}],"cOgIN":[function(require,module,exports,__globalThis) {
'use strict';
...
},{}],"llcxu":[function(require,module,exports,__globalThis) {
